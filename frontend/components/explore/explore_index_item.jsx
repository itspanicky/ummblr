        ...
        return (
            <div className="explore-index-item-container">
                <div className="explore post-author-container">
                    ...
                    />
                    {/* {follow} */}
                    <div className="explore-reblog-author">{reblogSymbol} {originalAuthor}</div>
                </div>
                <div className="post-body-container">
                ...
                <div className="explore post-action-container">
                    ...
                    <ul className="explore post-action-actions">
                        {commentBtn}
                        <li><i className="fas fa-retweet" onClick={() => this.props.openModal('Create Reblog', this.props.post.id)}></i></li>
                        <li>{likeBtn}</li>
                    </ul>
                </div>
            </div>
